...
export default function VideoCard({ title, isFree, price, previewUrl, isPlaceholder, onClick }: VideoCardProps) {
  ...
  // التصميم الأساسي للفيديوهات المتاحة
  return (
    <div 
      onClick={onClick} 
    ...
    >
      ...
      <div className="p-3.5 flex flex-col gap-2.5">
        ...
        <button className="w-full flex items-center justify-center gap-2 py-2.5 rounded-xl text-xs font-bold transition-colors bg-blue-600 text-white hover:bg-blue-700">
